...
tf.app.flags.DEFINE_string('data_path', 'C:\chatbot\chatbot_transformer\train_data_최종1.xlsx', 'data path')  # 데이터 위치
tf.app.flags.DEFINE_string('vocabulary_path', 'C:\chatbot\chatbot_transformer\data_out\\vocabularyData.voc', 'vocabulary path')  # 사전 위치
tf.app.flags.DEFINE_string('check_point_path', 'C:\chatbot\chatbot_transformer\data_out\check_point', 'check point path')  # 체크 포인트 위치
